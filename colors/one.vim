...
if has('gui_running') || has('termguicolors') || &t_Co == 88 || &t_Co == 256
  ...
  if &background ==# 'dark'
    ...
    let s:color237 = ['#000044','237']
    let s:color238 = ['#000044','238']
    let s:color239 = ['#000044','239']
    let s:color240 = ['#000044','240']
    let s:color241 = ['#000044','241']  " --- 浅灰
    ...
    let s:hue_2_2  = ['#4078f2', '93'] " blue
    let s:hue_3  = ['#a626a4', '127'] " purple
    " let s:hue_4  = ['#50a14f', '71'] " green
    let s:hue_4  = ['#50a14f', '34'] " green  #00af00 绿色
  ...
  let s:syntax_fg = s:color001    "  主要字体颜色
  ...
  " call <sid>X('Comment',        s:hue_2_2,        '',          s:italic)  " 注释修改这里
  call <sid>X('Comment',        s:color241,        '',          s:italic)  " 注释修改这里
